...
The current draft extension, **Volume 2: 2026 Pillar Update and SLM Agency
Direction**, updates those pillars against the present institutional AI
landscape. It argues that AI is now being embedded into nonprofits,
...
Volume 2 is intentionally published as a draft first. The v1.0 PDF editions and
OpenTimestamps proofs remain immutable canonical artifacts; any future Volume 2
PDF and timestamp proofs should be produced only after review.
